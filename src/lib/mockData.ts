...
const productionPRs: GitHubPullRequest[] = [
  {
    ...
    state: 'open',
    author: { username: 'charlie-fe', name: 'Charlie Lee', avatarUrl: 'https://i.pravatar.cc/150?img=3' },
    reviewers: [
      { username: 'alice-dev', name: 'Alice Kim', avatarUrl: 'https://i.pravatar.cc/150?img=1', status: 'approved' },
      { username: 'bob-design', name: 'Bob Park', avatarUrl: 'https://i.pravatar.cc/150?img=2', status: 'pending' },
    ],
  ...
  },
  {
    ...
    state: 'open',
    author: { username: 'eve-backend', name: 'Eve Jung', avatarUrl: 'https://i.pravatar.cc/150?img=5' },
    reviewers: [
      { username: 'alice-dev', name: 'Alice Kim', avatarUrl: 'https://i.pravatar.cc/150?img=1', status: 'approved' },
      { username: 'hong-qa', name: 'Hong Seongjun', avatarUrl: 'https://i.pravatar.cc/150?img=8', status: 'pending' },
    ],
    ...
    checks: [
      ...
      { id: 'check-prod-7', name: 'Integration Tests', status: 'in_progress', conclusion: null },
    ],
    filesChanged: [
      { filename:'src/main/kotlin/service/CacheService.kt', additions: 185, deletions: 0, status: 'added' },
      { filename:'src/main/kotlin/config/RedisConfig.kt', additions: 95, deletions: 45, status: 'modified' },
  ...
  },
  {
    ...
    state: 'open',
    author: { username: 'yoon-mobile', name: 'Yoon Jiyoung', avatarUrl: 'https://i.pravatar.cc/150?img=7' },
    reviewers: [
      { username: 'alice-dev', name: 'Alice Kim', avatarUrl: 'https://i.pravatar.cc/150?img=1', status: 'pending' },
      { username: 'hong-qa', name: 'Hong Seongjun', avatarUrl: 'https://i.pravatar.cc/150?img=8', status: 'pending' },
    ],
  ...
  },
  {
    ...
    additions: 567,
    deletions: 89,
    checks: [{ id: 'check-prod-10', name: 'Build', status: 'in_progress', conclusion: null }],
    filesChanged: [
      { filename:'src/services/offlineQueue.ts', additions: 234, deletions: 0, status: 'added' },
      { filename:'src/services/syncManager.ts', additions: 198, deletions: 0, status: 'added' },
      { filename:'src/contexts/OfflineContext.tsx', additions: 135, deletions: 89, status: 'modified' },
  ...
  },
  {
    ...
    state: 'open',
    author: { username: 'kang-devops', name: 'Kang Minsu', avatarUrl: 'https://i.pravatar.cc/150?img=6' },
    reviewers: [
      { username: 'alice-dev', name: 'Alice Kim', avatarUrl: 'https://i.pravatar.cc/150?img=1', status: 'approved' },
    ],
...
const productionIssues: GitHubIssue[] = [
  // Critical/High Priority Open Issues
  {
    ...
    state: 'open',
    author: { username: 'hong-qa', name: 'Hong Seongjun', avatarUrl: 'https://i.pravatar.cc/150?img=8' },
  ...
  },
  {
    ...
    state: 'open',
    author: { username: 'alice-dev', name: 'Alice Kim', avatarUrl: 'https://i.pravatar.cc/150?img=1' },
    assignees: ['eve-backend'],
  ...
  },
  {
    ...
    body: '## 제안\n\n- 읽지 않은 알림 배지 추가\n- 알림 타입별 필터링\n- 알림 우선순위 정렬',
    state: 'open',
    author: { username: 'bob-design', name: 'Bob Park', avatarUrl: 'https://i.pravatar.cc/150?img=2' },
    assignees: [],
  ...
  },
  {
    ...
    state: 'open',
    author: { username: 'david-pm', name: 'David Choi', avatarUrl: 'https://i.pravatar.cc/150?img=4' },
    assignees: ['eve-backend'],
    labels: ['documentation'],
    milestone: null,
    comments: [],
